...
- ПЕРСОНАЖИ: Тецель, Нэйе (за кадром, в переписке), четверо диверсантов (среди которых есть Рандз Инумори, ещё не Страж/Чистильщик), офицер СПО, Марион.
...
- ПЕРСОНАЖИ: Тецель, Тэцуко, Мориц, Марион.
...
4. КУЛЬТУРА УПАДКА. АКУ-фестиваль, в котором ГРАСП принимает активное участие, а Тецель проявляет обширные познания в древней АКУ-культуре, усвоенные от Тальмио. Тэцуко признаётся Тецелю в любви, но не получает взаимности и решает, что ему нравится Марион. В конце главы Тэцуко отбывает на континент, успев подсунуть Марион нестабильный артефакт, который та в дальнейшем использует.

- ОСНОВНЫЕ ПЕРСОНАЖИ: Тецель, Тэцуко, Мориц, Марион.

- ПЕРСОНАЖИ ОДНОЙ СЦЕНЫ: Лаура (*заметка из 2022: персонаж, которого я так и не продумал толком*), Гуннар (реконструктор, отыгрывает воина-наёмника из Форетенталя периода Семнадцати Царств), барон тьен Зарк-младший (Алай Менар).
...
- ПЕРСОНАЖИ: Тецель, Рэм Кисин, барон тьен Зарк-младший.
...
- ОСНОВНЫЕ ПЕРСОНАЖИ: Тальмио, Тецель, барон тьен Зарк-младший.
